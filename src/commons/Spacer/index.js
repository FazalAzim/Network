...
export const Spacer = ({ horizontal, height, width, style, isBasic, isSmall, isTiny, isXTiny, isDoubleBase, isStatusBarHeight, isHeaderHeight, isBottomTabBarHeight }) => {
